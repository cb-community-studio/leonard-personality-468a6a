...
import SingleResponsesPage from "../components/ResponsesPage/SingleResponsesPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/responses" component={ResponsesPage} exact />
                    <Route path="/responses/:singleResponsesId" component={SingleResponsesPage} exact />
                    {/* ~cb-add-route~ */}
